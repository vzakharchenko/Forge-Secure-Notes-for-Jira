...
import {SecurityNoteService} from "./SecurityNoteService";
...
export const KVS_SCHEMA_MIGRATION_SERVICE: KVSSchemaMigrationService = new KVSSchemaMigrationServiceImpl()