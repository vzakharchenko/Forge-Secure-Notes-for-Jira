...
import { CODEGEIST_LINK, MARKETPLACE_LINK, NAV_LINKS } from "@src/shared/constants";
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="block bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 py-2 px-4 text-center"
      >
      ...
      <div className="container mx-auto max-w-7xl px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="hidden lg:inline">Install from Marketplace</span>
        ...
        {/* Mobile menu */}
        {menuOpen && (
          <div className="lg:hidden bg-white border-t border-slate-100 py-3">
            {NAV_LINKS.map(({ href, label }) => (
              <a
                key={href}
                href={href}
