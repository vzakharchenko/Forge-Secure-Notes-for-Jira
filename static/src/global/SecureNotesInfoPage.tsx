...
export default function SecureNotesInfoPage() {
  return (
    <div style={{ maxWidth: 800, margin: "2rem auto", fontFamily: "sans-serif", lineHeight: 1.6 }}>
      ...
      <p>
        Secure Notes allows Jira users to share encrypted messages with specific teammates, linked
      ...
      <ul>
        ...
        <li>
          The key is not stored on the server — you must send it via Slack, email, or other secure
          methods.
        </li>
      </ul>
      ...
      <p>
        Notes automatically expire after a defined period (e.g., 1 hour). Expired or viewed notes
      ...
      <ul>
        <li>
          Keep sensitive information (like credentials or private instructions) out of comments.
        </li>
      ...
      <h2 style={{ marginTop: "2.5rem" }}>
        🚧 Known limitations (not included in the hackathon scope)
      </h2>
      <ul>
